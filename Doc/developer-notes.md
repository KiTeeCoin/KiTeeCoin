...
Run with the -testnet option to run with "play KiTeeCoins" on the test network, if you
...
KiTeeCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- KiTeeCoinMiner : Generates KiTeeCoins (if wallet is enabled - IN DEV).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:KiTeeCoin/KiTeeCoin.git
