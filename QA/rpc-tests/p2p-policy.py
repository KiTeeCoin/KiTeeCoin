...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    # spend seed money with a key not in the KiTeeCoin Core wallet.
    def spend_utxo(self, output):
        # construct the transaction using KiTeeCoin Core raw tx APIs
        ...
        # and send the tx from there rather than from KiTeeCoin Core, to test
