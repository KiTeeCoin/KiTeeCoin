KiTeeCoin Core version 1.14.5 is now available from:

  <https://github.com/KiTeeCoin/KiTeeCoin/releases/tag/v1.14.5/>

This is a new minor version release, including important security updates and
changes to network policies. All KiTeeCoin Core users, miners, services, relay
operators and wallet users are strongly recommended to upgrade.

Please report bugs using the issue tracker at github:

  <https://github.com/KiTeeCoin/KiTeeCoin/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/KiTeeCoindev/
  * @KiTeeCoin on Twitter for high priority announcements
  * @KiTeeCoin\_devs on Twitter for updates on development work

Compatibility
==============

KiTeeCoin Core is extensively tested on Ubuntu Server LTS, Intel-based macOS
and Windows 10.

KiTeeCoin Core should also work on most other Unix-like systems but is not
...
most KiTeeCoin Core users.

### Remote Code Execution in KiTeeCoin QT (CVE-2021-3401)
...
**KiTeeCoin QT users are urged to please update their installations to this
...
leakage of sensitive information when KiTeeCoin Core crashes on Unix platforms.
The vulnerability is patched for systems that run a Linux kernel equal to or
higher than 3.4.

**KiTeeCoin Core wallet users on Linux platforms are urged to please update to
this version.**
...
the KiTeeCoin network, following the reduction of relay and mining defaults in
...
* the recommended minimum transaction fee is 0.01 KITEE/kb, and
* the recommended dust limit is 1 KITEE, and
* the recommended RBF increment is 0.001 KITEE.

### Wallet/UI Changes

* The user interface for selecting fees when transacting KITEE has been updated
  to give an idea of how much is being spent, rather than a block target. As
  KiTeeCoin Teeblocks are not full, typically all transactions are mined in the next
  block, and therefore the target estimation does not makes sense for KiTeeCoin.
...
* The default minimum transaction fee is now 0.01 KITEE per kilobyte. Note that
...
* Introduce `-discardthreshold`, a wallet-specific, configurable dust limit that
  ...
  default dust limit is recommended to stay at 1 KITEE, as versions 1.14.2 until
  1.14.4 have a bug that rejects any transaction with an output under 1 KITEE.
...
* Split the dust limit into a hard and soft threshold, to reintroduce the
  ...
  * `-harddustlimit` is by default set at 0.001 KITEE and sets the value under
...
The Berkley DB version used by KiTeeCoin Core has been updated to 5.3 (from 5.1)
...
performance of cryptographic routines within KiTeeCoin Core.
